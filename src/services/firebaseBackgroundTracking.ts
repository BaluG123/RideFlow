...
export class FirebaseBackgroundTrackingService {
    ...
    private static async sendLocalFirebaseNotification(notification: {
        ...
        try {
            ...
            // This is a simplified approach - in production you might use FCM admin SDK
            ...
            // Use MessagingService to show notification
            await MessagingService.showLocalNotification(notification);
